...
exports.reverseBuffer = function(buff){
    const reversed = Buffer.allocUnsafe(buff.length);
...
exports.uint256BufferFromHash = function(hex){
    ...
    if (fromHex.length != 32){
        const empty = Buffer.allocUnsafe(32);
        empty.fill(0);
        fromHex.copy(empty);
        fromHex = empty;
    }
...
exports.varIntBuffer = function(n){
    if (n < 0xfd)
        ...
        const buff = Buffer.allocUnsafe(3);
        buff[0] = 0xfd;
        ...
        const buff = Buffer.allocUnsafe(9);
        buff[0] = 0xff;
...
exports.pubkeyToScript = function(key){
    ...
    var pubkey = Buffer.allocUnsafe(35);
    pubkey[0] = 0x21;
    pubkey[34] = 0xac;
...
exports.convertBitsToBuff = function(bitsBuff){
    ...
    var buff256 = Buffer.allocUnsafe(32);
    buff256.fill(0);
