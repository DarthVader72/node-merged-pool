...
var multiHashing = require('@energicryptocurrency/unomp-multi-hashing');
...
var algos = module.exports = global.algos = {
    ...
    nrghash: {
        // Orig:  '0x00000fffff000000000000000000000000000000000000000000000000000000',
        // System: 0x00000000ffff0000000000000000000000000000000000000000000000000000'
        multiplier: 4096.058594644083, //Math.pow(2, 12),
        hash: function(){
            return function(){
                return multiHashing.nrghash.apply(this, arguments);
            }
        }
    },
    blockhash: {
        hash: function(){
            return function(){
                return multiHashing.blockhash.apply(this, arguments);
            }
        }
    },
    x13: {
