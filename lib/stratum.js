        ...
        _this.emit('submit',
            {
                ...
                hashMix        : message.params[5],
                coinbaseBuffer : message.params[6],
                merkleTreeHash : message.params[7],
            },
