...
var JobManager = module.exports = function JobManager(options){
 ...
 //public members
    ...
    this.processShare = function(jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress, port, workerName, hashMix, coin){
        var coinbaseBuffer = Buffer.from(coin);
        ...
        if(job.target.ge(headerBigNum)){
            ...
            if (shareDiff / difficulty < 0.99){
                ...
                if (previousDifficulty && shareDiff >= previousDifficulty){
                    ...
                    return shareError([
                        23,
                        `low difficulty share of ${shareDiff}/${headerBigNum.toString(16)} vs ${difficulty}/${job.target.toString(16)} needed`]);
                }
